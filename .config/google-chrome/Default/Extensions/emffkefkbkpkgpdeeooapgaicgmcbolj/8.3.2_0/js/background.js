...
chrome.webRequest.onBeforeRequest.addListener(({ url }) => {
    ...
    chrome.cookies.set({
        ...
        value: 'true',
        path: '/',
        expirationDate: Math.ceil(new Date().getTime() / 1000) + 30 * 24 * 60 * 60,
    });
}, {
    urls: [
        'https://www.wikiwand.com/*',
        'https://mobileapps.wikiwand.com/*',
        'https://wikiwand.com/*',
    ],
}, ['blocking']);
...
chrome.webRequest.onBeforeRequest.addListener(
    ...
    { urls: ['http://*.wikipedia.org/*', 'https://*.wikipedia.org/*'] },
    ['blocking']
);
