...
function ccall(ident, returnType, argTypes, args, opts) {
    ...
    assert(
        ...
        'Cannot have multiple async ccalls in flight at once'
    );
        ...
        if (
            ...
            return fetch(wasmBinaryFile, { credentials: 'same-origin' }).then(
                function(response) {
                    ...
                    return result.then(receiveInstantiationResult, function(
                        reason
                    ) {
...
function _onSignatureReadyImpl(id, pointer, size) {
    onSignatureReady(id, pointer, size);
}
...
var asmLibraryArg = {
    ...
    fd_seek: _fd_seek,
    fd_write: _fd_write,
    onSignatureReadyImpl: _onSignatureReadyImpl,
...
/** @type {function(...*):?} */
var _extract_signature = (Module['_extract_signature'] = createExportWrapper(
    'extract_signature'
));
...
/** @type {function(...*):?} */
var _asyncify_stop_unwind = (Module[
