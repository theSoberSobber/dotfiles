...
},{"preact":"aSor","preact/hooks":"MwGB"}],"bqVo":[function(require,module,exports) {
...
},{}],"fE0U":[function(require,module,exports) {
"use strict";
...
},{"preact/hooks":"MwGB"}],"oVw8":[function(require,module,exports) {
"use strict";
...
function WatchOnLbryPopup(params) {
  ...
  return preact_1.h("div", {
  ...
  }), preact_1.h("header", null, preact_1.h("section", null, preact_1.h("img", {
    id: "logo",
    src: settings_1.targetPlatformSettings.odysee.button.icon
  }), preact_1.h("label", null, "Watch on Odysee"))), preact_1.h("main", null, preact_1.h("section", null, preact_1.h("label", null, "Pick a mode:"), preact_1.h("div", {
    className: 'options'
  }, preact_1.h("a", {
    ...
    className: `button ${redirect ? '' : 'active'}`
  }, "Show a button"))), preact_1.h("section", null, preact_1.h("a", {
...
function renderPopup() {
  preact_1.render(preact_1.h(WatchOnLbryPopup, null), document.getElementById('root'));
}

renderPopup();
},{"preact":"aSor","preact/hooks":"MwGB","../../components/dialogs":"R4Ey","../../modules/yt/urlCache":"bqVo","../../settings":"fE0U"}]},{},["oVw8"], null)