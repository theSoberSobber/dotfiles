	...
	new Vue({
		...
		store: new Vuex.Store({
			state: {
				...
				latestExtensionVersion: { latestVersion: true, urgentUpdate: false },
				userAvatar:
					discordUser && discordUser.avatar !== null
			...
			mutations: {
				updateConnectionState(state, payload) {
					...
					state.latestExtensionVersion = payload.latestExtensionVersion;
				},
