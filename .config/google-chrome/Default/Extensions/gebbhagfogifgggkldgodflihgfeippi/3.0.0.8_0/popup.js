...
function buttons_getLikeTextContainer() {
  return (
    ...
    buttons_getLikeButton().querySelector("span[role='text']")
  );
}
...
function createDislikeTextContainer() {
  const textNodeClone = buttons_getLikeButton().querySelector("button > div[class*='cbox']").cloneNode(true);
  const insertPreChild = buttons_getDislikeButton().querySelector("yt-touch-feedback-shape");
  buttons_getDislikeButton().querySelector("button").insertBefore(textNodeClone, insertPreChild);
